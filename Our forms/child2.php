...
function getData(){
  ...
  if(isset($_POST['Search'])){
      ...
      if(isset($_POST['Insert'])){
          $info=getData();
          $insert_query="INSERT INTO `childdata2`(`patient_id`, `dat1`, `dat2`, `dat3`, `dat4`, `scolor1`, `scolor2`, `scolor3`, `scolor4`, `eye1`, `eye2`, `eye3`, `eye4`, 
...
<form method="POST" action="child2.php">
