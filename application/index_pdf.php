...
class myPDF extends FPDF{
    ...
    function ViewTable($db,$id){//------------------------------this part should be change according to the form--------------------------------
        ...
        $this->Cell(30,8,'Blood Group:',0,0,'L');//------------------this is the name we given------------------------
        $this->Cell(20,8,$detail->BloodGroup,1,0,'C');//----------------------this is the name in database------------------------
        $this->Cell(50,8,'BMI:  ',0,0,'R');
        $this->Cell(20,8,$detail->BMI,1,0,'C');
        $this->Ln(20);

        $this->Cell(30,8,'Height:',0,0,'L');//------------------this is the name we given------------------------
        $this->Cell(20,8,$detail->height,1,0,'C');//----------------------this is the name in database------------------------
        $this->Ln(20);
        ...
        $this->Cell(40,8,'Name of the mother :',0,0,'L');//------------------this is the name we given------------------------
        $this->Cell(70,8,$detail->Name_of_the_mother,1,0,'C');//----------------------this is the name in database------------------------
        $this->Cell(50,8,'Age :  ',0,0,'R');
        $this->Cell(20,8,$detail->age,1,0,'C');
        $this->Ln(20);

        $this->Cell(40,8,'Name of the Hospital Clinic :',0,0,'L');//------------------this is the name we given------------------------
        $this->Ln();
        $this->Cell(150,8,$detail->Name_of_the_Hospital_Clinic,1,0,'C');//----------------------this is the name in database------------------------
        $this->Ln(20);
        ...
        $this->Cell(50,8,'Telephone number :',0,0,'L');//------------------this is the name we given------------------------
        $this->Cell(30,8,$detail->tele,1,0,'C');//----------------------this is the name in database------------------------
        $this->Ln(20);
        
        $this->Cell(50,8,'Name of the field Clinic :',0,0,'L');//------------------this is the name we given------------------------
        $this->Cell(70,8,$detail->Name_of_the_field_Clinic,1,0,'C');//----------------------this is the name in database------------------------
        $this->Cell(50,8,'Grama Niladari Division :',0,0,'R');
        $this->Cell(20,8,$detail->GramaNiladariDivision,1,0,'C');
        $this->Ln(20);

        $this->Cell(80,8,'Registration No.(Eligible Family Register) :',0,0,'L');//------------------this is the name we given------------------------
        $this->Cell(10,8,$detail->RegistrationNoEligibleFamilyRegister,1,0,'C');//----------------------this is the name in database------------------------
        ...
        $this->Cell(80,8,'Registration No.(Pregnant mothers Register) :',0,0,'L');//------------------this is the name we given------------------------
        $this->Cell(10,8,$detail->RegistrationNoPregnantmothersRegister,1,0,'C');//----------------------this is the name in database------------------------
        ...
        $this->Ln();
        $this->Cell(150,8,$detail->IdentifiedAntenatalRiskConditionsModifiers,1,0,'C');//----------------------this is the name in database------------------------
        $this->Ln(20);
