...
//------------------------------Following part should be change according to the form--------------------------------
    function ViewTable($db,$id){
        ...
        $this->Cell(30,8,'bcg',0,0,'L');//------------------this is the name we given. It will appear in the PDF.------------------------
        $this->Cell(20,8,$detail->bcg,1,0,'C');//----------------------this is the variable name in database------------------------
        $this->Cell(50,8,'bcg:  ',0,0,'R');
        $this->Cell(20,8,$detail->bcg,1,0,'C');
        $this->Ln(20);
        ...
        */
        ...
        $this->Cell(30,10,'Month 1',1,0,'C');
        $this->Cell(30,10,'Month 2',1,0,'C');
        $this->Cell(30,10,'Month 4',1,0,'C');
        $this->Cell(30,10,'Month 6',1,0,'C');
        $this->Cell(30,10,'Month 9',1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Clinic Attendance',1,0,'C');
        $this->Cell(30,10,$detail->day1,1,0,'C');
        $this->Cell(30,10,$detail->day2,1,0,'C');
        $this->Cell(30,10,$detail->day3,1,0,'C');
        $this->Cell(30,10,$detail->day4,1,0,'C');
        $this->Cell(30,10,$detail->day5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Congenital Deformities',1,0,'C');
        $this->Cell(30,10,$detail->attack1,1,0,'C');
        $this->Cell(30,10,$detail->attack2,1,0,'C');
        $this->Cell(30,10,$detail->attack3,1,0,'C');
        $this->Cell(30,10,$detail->attack4,1,0,'C');
        $this->Cell(30,10,$detail->attack5,1,0,'C');
        $this->Ln();
        ...
        $this->Cell(30,10,$detail->eye3,1,0,'C');
        $this->Cell(30,10,$detail->eye4,1,0,'C');
        $this->Cell(30,10,$detail->eye5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Vision of left eye',1,0,'C');
        $this->Cell(30,10,$detail->left1,1,0,'C');
        $this->Cell(30,10,$detail->left2,1,0,'C');
        $this->Cell(30,10,$detail->left3,1,0,'C');
        $this->Cell(30,10,$detail->left4,1,0,'C');
        $this->Cell(30,10,$detail->left5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Vision of right eye',1,0,'C');
        $this->Cell(30,10,$detail->right1,1,0,'C');
        $this->Cell(30,10,$detail->right2,1,0,'C');
        $this->Cell(30,10,$detail->right3,1,0,'C');
        $this->Cell(30,10,$detail->right4,1,0,'C');
        $this->Cell(30,10,$detail->right5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Hearing of left ear',1,0,'C');
        $this->Cell(30,10,$detail->hleft1,1,0,'C');
        $this->Cell(30,10,$detail->hleft2,1,0,'C');
        $this->Cell(30,10,$detail->hleft3,1,0,'C');
        $this->Cell(30,10,$detail->hleft4,1,0,'C');
        $this->Cell(30,10,$detail->hleft5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Hearing of right ear',1,0,'C');
        $this->Cell(30,10,$detail->hright1,1,0,'C');
        $this->Cell(30,10,$detail->hright2,1,0,'C');
        $this->Cell(30,10,$detail->hright3,1,0,'C');
        $this->Cell(30,10,$detail->hright4,1,0,'C');
        $this->Cell(30,10,$detail->hright5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Dental Deformity',1,0,'C');
        $this->Cell(30,10,'',1,0,'C',black);
        $this->Cell(30,10,'',1,0,'C',black);
        $this->Cell(30,10,'',1,0,'C',black);
        $this->Cell(30,10,$detail->tooth1,1,0,'C');
        $this->Cell(30,10,$detail->tooth2,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Dental Problems',1,0,'C');
        $this->Cell(30,10,'',1,0,'C',black);
        $this->Cell(30,10,'',1,0,'C',black);
        $this->Cell(30,10,'',1,0,'C',black);
        $this->Cell(30,10,$detail->fault1,1,0,'C');
        $this->Cell(30,10,$detail->fault2,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Weight',1,0,'C');
        $this->Cell(30,10,$detail->weight1,1,0,'C');
        $this->Cell(30,10,$detail->weight2,1,0,'C');
        $this->Cell(30,10,$detail->weight3,1,0,'C');
        $this->Cell(30,10,$detail->weight4,1,0,'C');
        $this->Cell(30,10,$detail->weight5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Height',1,0,'C');
        $this->Cell(30,10,$detail->height1,1,0,'C');
        $this->Cell(30,10,$detail->height2,1,0,'C');
        $this->Cell(30,10,$detail->height3,1,0,'C');
        $this->Cell(30,10,$detail->height4,1,0,'C');
        $this->Cell(30,10,$detail->height5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Development',1,0,'C');
        $this->Cell(30,10,$detail->develop1,1,0,'C');
        $this->Cell(30,10,$detail->develop2,1,0,'C');
        $this->Cell(30,10,$detail->develop3,1,0,'C');
        $this->Cell(30,10,$detail->develop4,1,0,'C');
        $this->Cell(30,10,$detail->develop5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Heart Problems',1,0,'C');
        $this->Cell(30,10,$detail->heart1,1,0,'C');
        $this->Cell(30,10,$detail->heart2,1,0,'C');
        $this->Cell(30,10,$detail->heart3,1,0,'C');
        $this->Cell(30,10,$detail->heart4,1,0,'C');
        $this->Cell(30,10,$detail->heart5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Hip Joint',1,0,'C');
        $this->Cell(30,10,$detail->joint1,1,0,'C');
        $this->Cell(30,10,$detail->joint2,1,0,'C');
        $this->Cell(30,10,$detail->joint3,1,0,'C');
        $this->Cell(30,10,$detail->joint4,1,0,'C');
        $this->Cell(30,10,$detail->joint5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Mecellaneous Conditions',1,0,'C');
        $this->Cell(30,10,$detail->disease1,1,0,'C');
        $this->Cell(30,10,$detail->disease2,1,0,'C');
        $this->Cell(30,10,$detail->disease3,1,0,'C');
        $this->Cell(30,10,$detail->disease4,1,0,'C');
        $this->Cell(30,10,$detail->disease5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,$detail->adisease0,1,0,'C');
        $this->Cell(30,10,$detail->adisease1,1,0,'C');
        $this->Cell(30,10,$detail->adisease2,1,0,'C');
        $this->Cell(30,10,$detail->adisease3,1,0,'C');
        $this->Cell(30,10,$detail->adisease4,1,0,'C');
        $this->Cell(30,10,$detail->adisease5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,$detail->bdisease0,1,0,'C');
        $this->Cell(30,10,$detail->bdisease1,1,0,'C');
        $this->Cell(30,10,$detail->bdisease2,1,0,'C');
        $this->Cell(30,10,$detail->bdisease3,1,0,'C');
        $this->Cell(30,10,$detail->bdisease4,1,0,'C');
        $this->Cell(30,10,$detail->bdisease5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,$detail->cdisease0,1,0,'C');
        $this->Cell(30,10,$detail->cdisease1,1,0,'C');
        $this->Cell(30,10,$detail->cdisease2,1,0,'C');
        $this->Cell(30,10,$detail->cdisease3,1,0,'C');
        $this->Cell(30,10,$detail->cdisease4,1,0,'C');
        $this->Cell(30,10,$detail->cdisease5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,$detail->ddisease0,1,0,'C');
        $this->Cell(30,10,$detail->ddisease1,1,0,'C');
        $this->Cell(30,10,$detail->ddisease2,1,0,'C');
        $this->Cell(30,10,$detail->ddisease3,1,0,'C');
        $this->Cell(30,10,$detail->ddisease4,1,0,'C');
        $this->Cell(30,10,$detail->ddisease5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,$detail->edisease0,1,0,'C');
        $this->Cell(30,10,$detail->edisease1,1,0,'C');
        $this->Cell(30,10,$detail->edisease2,1,0,'C');
        $this->Cell(30,10,$detail->edisease3,1,0,'C');
        $this->Cell(30,10,$detail->edisease4,1,0,'C');
        $this->Cell(30,10,$detail->edisease5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,$detail->fdisease0,1,0,'C');
        $this->Cell(30,10,$detail->fdisease1,1,0,'C');
        $this->Cell(30,10,$detail->fdisease2,1,0,'C');
        $this->Cell(30,10,$detail->fdisease3,1,0,'C');
        $this->Cell(30,10,$detail->fdisease4,1,0,'C');
        $this->Cell(30,10,$detail->fdisease5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Name of Examiner',1,0,'C');
        $this->Cell(30,10,$detail->name1,1,0,'C');
        $this->Cell(30,10,$detail->name2,1,0,'C');
        $this->Cell(30,10,$detail->name3,1,0,'C');
        $this->Cell(30,10,$detail->name4,1,0,'C');
        $this->Cell(30,10,$detail->name5,1,0,'C');
        $this->Ln();
        $this->Cell(47,10,'Post of Examiner',1,0,'C');
        $this->Cell(30,10,$detail->position1,1,0,'C');
        $this->Cell(30,10,$detail->position2,1,0,'C');
        $this->Cell(30,10,$detail->position3,1,0,'C');
        $this->Cell(30,10,$detail->position4,1,0,'C');
        $this->Cell(30,10,$detail->position5,1,0,'C');
        $this->Ln(20);
