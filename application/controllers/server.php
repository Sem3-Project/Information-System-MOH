<?php
/*Includes the code that will receive submitted from the form and store
(register) the information in the database*/

session_start(); //sessions are used o track logged in users
...
if (isset($_POST['reg_user'])) { 
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO users (username,id, catagory, password) 
  			  VALUES('$username','$id', '$catagory', '$password')";
